-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\detector\adderQ.vhd
...
-- 
-- Module: adderQ
-- Source Path: detector/detector/adderQ
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  adderQ_1_process : PROCESS (clk, reset)
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS adderQ_1_process;

  adderQ_1_output : PROCESS (level1, level2, sequence_signed, sumVal_reg)
