...
pll_sd_ctrl_help = 'PLL SD control\nBits\n0\tSD Reset (0 = Reset active, 1 = Reset inactive)\n1\tSD Enable\n2\tPRBS Enable\n6:4\tDither enable ( SD stage)'
pll_sd_cfg_help = 'PLL SD Configuration\nBits\n1:0\tSD Order\n5:4\tSD Multi level'
pll_sd_k_help = 'PLL SD K-value\nBits\n23:0\tK-value'
pll_sd_num_help = 'PLL SD Numerator\nBits\n15:0\tNumerator value'
pll_sd_den_help = 'PLL SD Denominator\nBits\n15:0\tDenominator value'
...
vco_tune_fd_cfg_help = 'VCO Tune Frequency Configuration\nBits\n7:4\tVCO clock counter step size (log2-value)\n3:0\tReference clock counter step size (log2-value)'
vco_atc_del_help = 'VCO ATC Delay value'
...
rx_bb_drv_q_dco_help = 'RX BB Output driver Q-channel DC Offset\nBits 6:0 value(Offset)\n0x7F: Max positive offset value\n0x40: No offset compensation\n0x00: Max negative offset value\n\nBits 9:8 lsb (??)\n00: ??\n01: ??\n10: ??\n11: ??'
rx_bb_drv_i_dco_help = 'RX BB Output driver I-channel DC Offset\nBits 6:0 value(Offset)\n0x7F: Max positive offset value\n0x40: No offset compensation\n0x00: Max negative offset value\n\nBits 9:8 lsb (??)\n00: ??\n01: ??\n10: ??\n11: ??'
...
reg_00_help = 'General purpose register\nRegister can be used for storing FW driver runtime values. EVK makes use of the registers.'

no_help_text = 'Help text'
